...
<body>
	...
	<div class="container">
		<div class="left">
			...
			<form action="${pageContext.request.contextPath}/login" class="form" method="post" autocomplete="off">
				<input data-aos="zoom-out-right" data-aos-delay="1400" data-aos-duration="1400" type="text"
					name="username" class="form-field" placeholder="Username" />
				<input data-aos="zoom-out-right" data-aos-delay="1600" data-aos-duration="1400" type="password"
					name="password" class="form-field" placeholder="Password" />
